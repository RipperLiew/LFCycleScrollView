...
@objc protocol LFCycleScrollViewDelegate
{
    /// 点击图片回调
    @objc optional func cycleScrollViewDidSelect(at index:Int,cycleScrollView:LFCycleScrollView)
    
    /// 图片滚动回调
    @objc optional func cycleScrollViewDidScroll(to index:Int,cycleScrollView:LFCycleScrollView)
}

class LFCycleScrollView: UIView, EndlessScrollProtocol, PageControlAlimentProtocol {
    

    ///对外提供的属性
    weak var delegate:LFCycleScrollViewDelegate?
    ...
    fileprivate let CellID = "LFCycleCell"
    fileprivate var pageControl:LFPageControl?
    var timer:Timer?
...
// MARK:- pageControl页面
extension LFCycleScrollView{
    
    
    fileprivate func setupPageControl(){
        pageControl?.removeFromSuperview()
        if showPageControl == true {
            pageControl = LFPageControl(frame: .zero, currentImage: currentPageDotImage, defaultImage: defaultPageDotImage)
            pageControl?.numberOfPages = imgsCount
            pageControl?.hidesForSinglePage = true
            pageControl?.currentPageIndicatorTintColor = currentDotColor
            pageControl?.pageIndicatorTintColor = otherDotColor
...
// MARK:- LFCycleCell 相关
extension LFCycleScrollView: UICollectionViewDelegate,UICollectionViewDataSource{
    fileprivate func setupCollectionView(){
        ...
        collectionView?.register(LFCycleCell.self, forCellWithReuseIdentifier: CellID)
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        let cell = collectionView.dequeueReusableCell(withReuseIdentifier: CellID, for: indexPath) as! LFCycleCell
